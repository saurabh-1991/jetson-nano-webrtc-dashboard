...
docker run -d \
  ...
  -e MODBUS_HOST="${MODBUS_HOST:-192.168.0.200}" \
  -e MODBUS_TCP_PORT="${MODBUS_TCP_PORT:-4196}" \
  ...
  -e FLOW_METER_HOST="${FLOW_METER_HOST:-192.168.0.200}" \
  -e FLOW_METER_TCP_PORT="${FLOW_METER_TCP_PORT:-4196}" \
  ...
  -e VFD_HOST="${VFD_HOST:-192.168.0.200}" \
  -e VFD_PORT="${VFD_PORT:-4196}" \
  ...
  -e VFD2_HOST="${VFD2_HOST:-192.168.0.200}" \
  -e VFD2_PORT="${VFD2_PORT:-4196}" \
  ...
  -e VFD2_RUN_FORWARD_WORD="${VFD2_RUN_FORWARD_WORD:-1}" \
  -e VFD2_STOP_WORD="${VFD2_STOP_WORD:-0}" \
